...
function signup($username,$email,$password,$firstname,$lastname,$gender,$address,$conn)
{
	$sql = "INSERT INTO users (uidUsers,emailUsers,pwdUsers,firstnameUsers,lastnameUsers,genderUsers,addressUsers) VALUES (?,?,?,?,?,?,?)";
	...
	if (!mysqli_stmt_prepare($stmt,$sql)) {
		...
		mysqli_stmt_bind_param($stmt,"sssssss",$username,$email,$hashedPwd,$firstname,$lastname,$gender,$address);
