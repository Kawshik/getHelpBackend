...
$HELPER_IS_NOT_FOUND_ERROR_CODE = 501;
$DANGER_FOUND_ERROR_CODE = 501;
...
$HELPER_IS_NOT_FOUND_ERROR_MSG = "The helperId is not set";
$DANGER_FOUND_ERROR_MSG = "These means there might not be anything in the database";
...
function errorHandler($errorCode) {
	switch ($errorCode) {
		...
		case $MYSQL_CONN_ERROR_ERROR_CODE:
			...
			break;
		case $HELPER_IS_NOT_FOUND_ERROR_CODE:
			return $HELPER_IS_NOT_FOUND_ERROR_MSG;
			break;
		default:
